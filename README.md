# Webhook2MQTT
This enable a pretty easy python/flask Application that takes all incoming (json) messages as a webhook/API Integration (for example for netatmo.com or telegram or thethingsnetwork.com (TTN)) and forwards it to a given mqtt-adress.
